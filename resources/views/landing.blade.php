...
<body class="bg-[#0F1729] text-[#F5F3EE] font-sans antialiased selection:bg-[#E8734A] selection:text-white min-h-screen flex flex-col"
                ...
                <div class="flex items-center gap-3">
                    @auth
                        ...
                        <form method="POST" action="{{ route('logout') }}" class="inline">
                            @csrf
                            <button type="submit" class="p-2 text-[#9BA3B8] hover:text-[#F5F3EE] rounded-[8px] hover:bg-[#1A2540] transition-colors" title="Keluar">
                                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <main class="flex-grow">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
                    ...
                    <div class="lg:col-span-7 flex flex-col items-start text-left">
                        ...
                        <div class="w-full max-w-xl bg-[#1A2540] p-2 rounded-[8px] border border-white/[0.08] shadow-xl flex flex-col sm:flex-row gap-2 mb-8">
                        ...
                        <div class="grid grid-cols-3 gap-6 pt-4 border-t border-white/[0.08] w-full max-w-lg">
                            <div>
                                <div class="text-2xl font-bold text-[#F5F3EE]">24+</div>
                                <div class="text-xs text-[#9BA3B8] mt-0.5">Event Aktif</div>
                            </div>
                            <div>
                                <div class="text-2xl font-bold text-[#E8734A]">1.500+</div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between gap-4 overflow-x-auto pb-2 sm:pb-0 scrollbar-none">
                    ...
                    <div class="flex items-center gap-2.5 flex-nowrap">
                        ...
                        <button @click="activeCategory = 'seminar'"
                                :class="activeCategory === 'seminar'
                                    ? 'bg-[#E8734A] text-white font-semibold'
                                    : 'bg-[#1A2540] hover:bg-white/[0.06] text-[#9BA3B8] hover:text-[#F5F3EE] border border-white/[0.08]'"
                                class="px-4 py-2 rounded-[8px] text-xs transition-all whitespace-nowrap">
                            Seminar & Talkshow
        ...
        <section id="rekomendasi" class="py-5">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="p-5 flex flex-col flex-grow justify-between">
                            <div>
                                <h3 class="text-base font-semibold text-[#F5F3EE] group-hover:text-[#E8734A] transition-colors line-clamp-2 leading-snug mb-2">
                                    Workshop Modern Web Development: Laravel 12 & Tailwind CSS
                                </h3>

                                <p class="text-xs text-[#9BA3B8] line-clamp-2 mb-4 leading-relaxed">
                                    Pelajari arsitektur fullstack modern, pembuatan RESTful API, dan styling efisien langsung dengan praktisi.
                                </p>
                                ...
                                <div class="space-y-2 mb-4 text-xs text-[#9BA3B8]">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span>08:30 - 14:00 WIB</span>
                                    </div>
                                    <div class="flex items-center gap-2">
                                        <svg class="w-3.5 h-3.5 text-[#E8734A]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                                        </svg>
                                        <span class="truncate">Lab Komputer RPL 1</span>
                                    </div>
                                    <div class="flex items-center gap-2">
                                        <svg class="w-3.5 h-3.5 text-[#E8734A]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                        </svg>
                                        <span class="truncate">Penyelenggara: Jurusan RPL</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="pt-4 border-t border-white/[0.08]">
                                <div class="flex items-center justify-between text-xs mb-3">
                                    ...
                                    <span class="text-[#9BA3B8]">Kapasitas: <strong class="text-[#F5F3EE]">42/50</strong></span>
                                </div>
                                <a href="{{ route('login') }}"
                ...
                <div class="mt-12 text-center">
                    <a href="{{ route('login') }}"
                       class="inline-flex items-center gap-2 px-6 py-3 rounded-[8px] bg-[#1A2540] hover:bg-[#1A2540]/80 text-[#F5F3EE] border border-white/[0.08] hover:border-[#E8734A]/40 text-sm font-semibold transition-all">
                        <span>Lihat Semua Daftar Event (24 Event)</span>
                        <svg class="w-4 h-4 text-[#E8734A]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <section class="py-16">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="bg-gradient-to-r from-[#1A2540] via-[#1A2540] to-[#E8734A]/20 rounded-[8px] border border-white/[0.08] p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
                    <div>
                        <h3 class="text-xl sm:text-2xl font-bold text-[#F5F3EE] mb-2">
                            Punya ide atau ingin menyelenggarakan event sekolah?
                        </h3>
                        <p class="text-sm text-[#9BA3B8] max-w-xl">
                            Hubungi panitia atau pengelola jurusan untuk mempublikasikan dan mengelola peserta kegiatanmu secara profesional.
                        </p>
                    </div>
                    <a href="{{ route('register') }}"
                       class="px-6 py-3 bg-[#E8734A] hover:bg-[#F2A671] text-white font-semibold text-sm rounded-[8px] transition-all whitespace-nowrap shadow-lg">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="text-[11px] text-[#9BA3B8]/80">
                        📍 Jl. Pendidikan No. 45, Kompleks Sekolah Menengah Kejuruan
                    </div>
                </div>
            ...
            <div class="pt-8 border-t border-white/[0.08] flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px]">
                <div>
                    &copy; {{ date('Y') }} EventSekolah. Hak Cipta Dilindungi Undang-Undang.
                </div>
